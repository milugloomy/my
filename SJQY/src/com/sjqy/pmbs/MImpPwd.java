...
@Service("MImpPwdBatchTransAction")
public class MImpPwd  extends AbstractParentBatch{
	...
	public void execute(Map<String, Object> context) {
		...
		File file=new File(p.getProperty("mimpPath"));
	...
	private final String updateECUSRMCH ="update ECUSRMCH set "
			+ "password=? where mchannelid='PMBS' "
