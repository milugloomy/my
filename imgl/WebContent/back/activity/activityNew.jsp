...
<link rel="stylesheet"
	href="/imgl/css/font-awesome/css/font-awesome.css">
...
<div class="content">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form id="form" method="post" action="/imgl/backActivityNew.do">
			<table class="table">
				<tr>
					<td style="width: 20%; border-top: none;">商品名称:</td>
					<td style="border-top: none;">
					<input type="text" id="productName" name="productName" placeholder="请输入商品名称"></td>
				</tr>
				<tr>
					<td>标题:</td>
					<td><input type="text" id="title" name="title" style="width:90%" placeholder="请输入标题"></td>
				</tr>
				<tr>
